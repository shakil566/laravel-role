                        ...
                        <div class="row">
                            <div class="col-md-8">
                                <h4 class="card-title mt-0">User List
                                    ...
                                    {{-- <a class="btn btn-default btn-sm create-new" href="{{ URL::to('/admin/user/create') }}">
                                        Add
                                        New
                                                ...
                                                <td class="td-actions text-center vcenter">
                                                    {{-- <div class="width-inherit">
                                                        <a class="btn btn-xs btn-primary tooltips" title="Edit"
                                                            href="{{ URL::to('/admin/user/' . $target->id . '/edit') }}">
                                                            <i class="fa fa-edit"></i>
                                                        </a>

                                                        {{ Form::open(['url' => '/admin/user/' . $target->id, 'class' => 'delete-form-inline','id' => 'delete']) }}
